...
import java.util.Vector;// Importing Vector class for dynamic array
import java.util.logging.Level;// Importing logging levels for logger
...
import javax.swing.table.DefaultTableModel;// Importing DefaultTableModel for table operations

public class StudentForm extends javax.swing.JFrame {
 // Class-level variables for database connection and prepared statements
    public StudentForm() {
    ...
    ResultSet rs;
// Constructor to initialize components and establish database connection
    public void Connect() {
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cat_oop", "root", "");
   ...
   // Method to initialize GUI components (generated by NetBeans GUI Builder)
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 200, 270, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 420, 229));

        jLabel3.setText("Highest Performer:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 230, 130, -1));

        pack();
    }// </editor-fold>//GEN-END:initComponents
// Action listener for the Exit button to terminate the application
